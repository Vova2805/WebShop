...
(function (factory) {
            ...
            menuPosition: function ($sub) {
                ...
                if (this.opts.keepInViewport) {
                    ...
                    if (horizontalParent && (absY + subH > winY + winH + 0.49 || absY < winY) || !horizontalParent && subH > winH + 0.49) {
                        ...
                        // since there is no other way to access such int sub menus if no mouse is present
                        if (this.isFixed()) {
                ...
                if (!$sub.is(':visible')) {
                    ...
                    if (this.isCollapsible()) {
                        ...
                        if (this.opts.subMenusMinWidth || this.opts.subMenusMaxWidth) {
                            $sub.css({width: '300px', minWidth: '200px', maxWidth: ''}).addClass('sm-nowrap');
    ...
    $.fn.smartmenus.defaults = {
        ...
        scrollStep: 30,		// pixels step when scrolling int sub menus that do not fit in the viewport height
