<div class="row-fluid">
    ...
    <div class="row-fluid ">
        <div class="col-md-3">
            <div class="small-box faded-buttons-area">
                <figure>
                    <div class="inner">
                        <h3>44</h3>
                        <div class="aa-product-hvr-content relative">
                            <a class="cursor-hand" onclick="tooglePartsVisibility('test1','test2')"
                               data-toggle="tooltip"
                               data-placement="top" title="Edit">
                                <span class="fa fa-pencil"></span></a>
                            <a href="#" data-toggle2="tooltip" data-placement="top" title="Remove"
